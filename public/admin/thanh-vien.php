                    ...
                    <table id="datatable1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            // <?php
                                ...
                                ?>
                            <?php
                            $result = $NTA->get_list("SELECT * FROM `users` ORDER BY id desc");
                            if ($result) {
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a type="button" class="btn btn-default" href="edit-thanh-vien.php?username=<?= $row["username"]; ?>">
...
if (isset($_POST["btn_submit"])) {
   ...
   // $query_user_dangky = mysqli_query($ketnoi, "");
    //$query_user_dangky = $NTA->query("");
    $biensosanh = str_replace(" ", "", $username);


    if ($NTA->num_rows("SELECT * FROM `users` WHERE `username` = '" . $username . "'")  > 0) {
