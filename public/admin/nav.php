                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="nap-the.php" class="nav-link">
                                <p><i class="nav-icon fa fa-credit-card"></i> THỐNG KÊ NẠP TIỀN</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="momo.php" class="nav-link">
                                <p><i class="nav-icon fa fa-credit-card"></i>QUẢN LÍ MOMO</p>
                            </a>
                        </li>
                        <!-- <li class="nav-item">
                  ...
                  <p><i class="nav-icon fa fa-book" aria-hidden="true"></i> QUẢN LÝ CLONE - VIA</p>
                        ...
                        <li class="nav-item">
                            <a href="bank.php" class="nav-link">
                                <p><i class="nav-icon fa fa-university" aria-hidden="true"></i>THÊM NGÂN HÀNG</p>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="loai_chuyen_muc.php" class="nav-link">
                                <p><i class="nav-icon fa fa-gift" aria-hidden="true"></i> CHUYÊN MỤC TÀI KHOẢN</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="chuyen-muc.php" class="nav-link">
                                <p><i class="nav-icon fa fa-tag" aria-hidden="true"></i> THỂ LOẠI TÀI KHOẢN</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="tai-khoan.php" class="nav-link">
                                <p><i class="nav-icon fa fa-book" aria-hidden="true"></i>QUẢN LÍ TÀI KHOẢN</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="thong-bao.php" class="nav-link">
                                <p><i class="nav-icon fa fa-envelope-open" aria-hidden="true"></i> THÔNG BÁO WEBSITE</p>
                            </a>
                        </li>
                        <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="nap.php" class="nav-link">
                                <p><i class="nav-icon fa fa-cogs" aria-hidden="true"></i> CẤU HÌNH NẠP AUTO</p>
                            </a>
                        </li>
